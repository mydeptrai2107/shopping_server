...
productRouter.get("/api/get-product-rating/:id", async (req, res) => {
...
productRouter.get("/api/get-ratings-average/:id", async (req, res) => {
    try {
...
productRouter.get("/api/get-average-ratings-length/:id", async (req, res) => {
